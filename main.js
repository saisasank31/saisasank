...
function details(det){
  ...
  mail.href = "mailto:saisasank31@gmail.com";
...
function careerinfo(infodata){
  var careerinfo = document.createElement("h2");
  careerinfo.textContent = "career objective:";
...
function techinicalskills(tech){
  var det = document.createElement("h3");
  det.textContent = "techinical skills:";
